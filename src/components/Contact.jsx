                    ...
                    <div className="contact-info animate-slide-in-left">
                        ...
                        <div className="contact-methods">
                            <div className="contact-method">
                                ...
                                <div className="method-content">
                                    <h4>Email</h4>
                                    <a href="mailto:contact@johann.dev">contact@johann.dev</a>
                                </div>
                            </div>
                        ...
                        <div className="social-links">
                            ...
                            <div className="social-icons">
                                <a href="https://github.com/Zideee" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
